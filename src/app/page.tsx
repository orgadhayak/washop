...
export default function Home() {
  const faqItems = [
    ["מהו וואשופ?", "וואשופ היא ספריית גילוי ואינדקס של חנויות ועסקים שמציגים מוצרים או שירותים ומאפשרים קשר ישיר בוואטסאפ. וואשופ אינה צד בעסקה ואינה מבצעת תשלומים."],
    ["איך מוצאים חנות בוואשופ?", "מחפשים לפי קטגוריה, עיר, מוצר או שם עסק, פותחים את הכרטיס ובודקים את הקטלוג או פונים ישירות לבית העסק."],
    ...
    ["האם אפשר ליצור קשר עם העסק דרך וואטסאפ?", "כן. בכרטיסים המאושרים אפשר לפתוח קטלוג או לשלוח הודעה ישירה, ולאשר מול העסק את כל פרטי ההתקשרות."],
    ["האם וואשופ מבצעת את התשלום?", "לא. התשלום, המשלוח, ההחזרות והשירות מסוכמים ישירות בין הלקוח לבין העסק."],
    ["האם וואשופ אחראית לשירות שהעסק מספק?", "לא. וואשופ בודקת חנויות לפני פרסום, אך העסק אחראי למוצרים, למחירים, לתנאים ולשירות שהוא מספק."],
  ];
  const jsonLd = [
    {
      ...
      alternateName: ["וואשופ", "WaShop", "washop.co.il"],
    ...
    },
    {
      ...
      alternateName: ["WaShop", "washop.co.il"],
      url: siteConfig.domain,
