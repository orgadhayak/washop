...
const importantItems = [
  ...
  "חנות שאושרה יכולה להופיע גם ב־WaShop Global, אך אין בכך הבטחה לפניות, מכירות או משלוח בינלאומי.",
        ...
        <div className="mt-8 grid gap-5">
          ...
          <section className="rounded-lg border border-emerald-200 bg-emerald-50 p-6">
            ...
            <p className="mt-4 text-lg leading-9 text-zinc-700">
              ...
              דרך האתר. אם החנות מופיעה גם ב־WaShop Global, עליה להבהיר ישירות
              ללקוח זמינות, יעדי משלוח, תשלום, החזרות ושירות.
            </p>
            <Link
              href="/add-store"
