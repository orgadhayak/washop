...
const categoryEditorialContent: Record<string, CategoryEditorialContent> = {
  ...
  "technical-services-businesses": {
    heading: "שירותי פיתוח ווב ותמיכה טכנית לעסקים",
    description:
      "גלו נותני שירות מאושרים לשירותי פיתוח ווב, תמיכה טכנית, פתרון תקלות וכלים דיגיטליים לעסקים. אפשר להסביר את הצורך ולברר ישירות התאמה, זמינות, היקף טיפול ועלות.",
    ...
    faqs: [
      ...
      {
        question: "מה כוללים שירותי פיתוח ווב לעסק?",
        answer:
          "שירותי פיתוח ווב יכולים לכלול אפיון, בניית אתר או פורטל, חיבור למערכות, תיקוני קוד ותחזוקה. חשוב לסכם מול נותן השירות את היקף העבודה, הבעלות והתמיכה.",
      },
      {
...
export async function generateMetadata({
  ...
  const titleBySlug: Record<string, string> = {
    ...
    "technical-services-businesses": "שירותי פיתוח ווב ותמיכה טכנית לעסקים דרך וואטסאפ בוואשופ",
  };
  const title =
