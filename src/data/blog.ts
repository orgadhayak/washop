...
export const blogPosts = [
  {
    ...
    excerpt:
      "חנויות רבות בישראל מוכרות דרך קטלוג וואטסאפ בלי אתר מסובך. בוואשופ אפשר להגיש חנות לבדיקה בצורה פשוטה — שולחים קישור, מספר וכמה מילים על העסק, ואנחנו בודקים התאמה.",
