...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: "חנות וירטואלית בוואטסאפ – איך פותחים קטלוג | WaShop",
    metaDescription:
      "מדריך לחנות וירטואלית בעברית: איך מכינים קטלוג וואטסאפ, מציגים מוצרים ומחירים, מקבלים הזמנות ומבינים מתי נדרש אתר חנות מלא.",
