...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: "איך פותחים חנות וירטואלית בוואטסאפ? | Washop",
    metaDescription:
      "איך פותחים חנות וירטואלית בוואטסאפ? מדריך שלב אחר שלב להכנת קטלוג, קבלת פניות, סיכום תשלום ומשלוח והגשת העסק לבדיקה בוואשופ.",
