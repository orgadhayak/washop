...
export const shops = [
  ...
  },
  {
    ...
    metaTitle: "ליאל מארזים מתנות והדפסות חנות וואטסאפ ביהוד",
    metaDescription:
      "מארזי מתנה בעיצוב אישי, הדפסות ומוצרים מיוחדים דרך קטלוג וואטסאפ. ליאל מארזים מתנות והדפסות היא חנות ביהוד שנבדקה ידנית בוואשופ.",
