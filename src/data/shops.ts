...
export const shops = [
  ...
  },
  {
    ...
    name: "באמפרס",
    description:
      "באמפרס היא חנות וואטסאפ מראשון לציון המתמחה בכפכפי עיסוי, נעלי נוחות וקולקציות לגברים ולנשים. דרך קטלוג הוואטסאפ אפשר לראות מוצרים, מידות ומחירים ולפנות ישירות לבית העסק.",
    shortDescription: "כפכפי עיסוי ונעלי נוחות",
    cardDescription: "כפכפי עיסוי ונעלי נוחות דרך קטלוג וואטסאפ.",
    searchAliases: [
      "Bumpers",
      "bumpers massage",
      "כפכפים",
    ...
    metaTitle: "באמפרס | כפכפי עיסוי ונעלי נוחות בראשון לציון | וואשופ",
    metaDescription:
      "באמפרס היא חנות וואטסאפ מראשון לציון לכפכפי עיסוי, נעלי נוחות וקולקציות לגברים ולנשים — נבדקת ידנית על ידי וואשופ.",
